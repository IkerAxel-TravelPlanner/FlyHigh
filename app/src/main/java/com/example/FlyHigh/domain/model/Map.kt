...
class Map {
    ...
    fun getDirections(start: ExerciseRoute.Location, end: ExerciseRoute.Location): com.google.android.libraries.mapsplatform.transportation.consumer.model.Route? = null
}