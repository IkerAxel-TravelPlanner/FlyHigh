...
fun NotificationsScreen(navController: NavHostController) {
    Scaffold(
        ...
        Column(
            ...
            Text(
                text = stringResource(id = R.string.notifications_description),
                style = MaterialTheme.typography.bodyMedium,
                modifier = Modifier.padding(bottom = 32.dp)
            )

            // Aquí puedes agregar opciones para activar/desactivar notificaciones
            ElevatedButton(
                ...
                Text(text = stringResource(id = R.string.configure_notifications), color = Color.White)
            }
        }
    }
}
